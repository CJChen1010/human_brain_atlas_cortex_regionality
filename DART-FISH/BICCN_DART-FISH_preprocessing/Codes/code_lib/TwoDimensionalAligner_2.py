...
import sys
sitkPath = '/media/Home_Raid1_Voyager/chc352/SimpleElastix_201012/build/SimpleITK-build/Wrapping/Python'
...
class ImageTransformer:
    ...
    def findTransformParameters(self, transform = "affine", NumberOfResolutions = 6, MaximumNumberOfIterations = 1000, NumberOfSpatialSamples = 4000):   
