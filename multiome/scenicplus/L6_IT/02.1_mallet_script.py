...
def main(n_topic, obj_path):
    ...
    out_dir = "/tscc/projects/ps-epigen/users/biy022/biccn/data/SNAREdata/scenicplus/L6_IT/pycistopic_outputs"
    path_to_mallet_binary = "/tscc/nfs/home/biy022/softwares/scenicplus/Mallet-202108/bin/mallet"
    tmp_path = "/tscc/projects/ps-epigen/users/biy022/biccn/data/scplus_tmp/L6IT_{}".format(n_topic)
