RESDIR=/tscc/projects/ps-epigen/users/biy022/biccn/data/SNAREdata/scenicplus/L5_ET/rostral_caudal_spearman/peaks_bh_1e-1_donor_replicate
ROOT=/tscc/projects/ps-epigen/users/biy022/biccn/data/SNAREdata/scenicplus/L5_ET/rostral_caudal_spearman
cd $ROOT
mkdir -p ${RESDIR}/pbs_scripts
mkdir -p ${RESDIR}/pbs_logs

for file in *_peaks_bh_1e-1_donor_replicate.bed
do
    subname=$(basename $file _peaks_bh_1e-1_donor_replicate.bed)
