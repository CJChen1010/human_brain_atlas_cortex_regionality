...
for file in *_atac_corr_5e-1_bh_5e-2_donor.bed
do
    subname=$(basename $file _atac_corr_5e-1_bh_5e-2_donor.bed)
    mkdir -p ${RESDIR}/${subname}_correlation
    cat >${RESDIR}/pbs_scripts/${subname}.sh <<EOF
#! /bin/bash
#SBATCH -p condo
...
# ST axis
RESDIR=/tscc/projects/ps-epigen/users/biy022/biccn/data/SNAREdata/scenicplus/L4_IT/sensorimotor_transmodel_spearman_expr_filtered/homer
ROOT=/tscc/projects/ps-epigen/users/biy022/biccn/data/SNAREdata/scenicplus/L4_IT/sensorimotor_transmodel_spearman_expr_filtered
